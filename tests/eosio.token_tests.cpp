...
public:
   ...
   eosio_token_tester() {
      ...
      create_accounts( { N(alice), N(bob), N(carol),N(boblacklist),N(boblacklist1),N(boblacklist2),N(boblacklist3),N(boblacklist4),N(boblacklist5), N(eosio.token) } );
      produce_blocks( 2 );
